        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label for="tel_add_input" class="col-sm-2 control-label">工作电话</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <select class="form-control" name="gId" id="group_add_area">
                            </select>
                        </div>
                    </div>
                </form>
...
<script type="text/javascript">
    ...
    function build_emps_table(result) {
        ...
        console.log("数据：" + JSON.stringify(emps));
        ...
        $.each(emps, function (index, item) {
            ...
            var groupNameId = $("<td></td>").append(item.group.groupName);
            /**
            ...
            $("<tr></tr>").append(checkBoxTd).append(empIdTd).append(empNameTd).append(
                genderTd).append(phoneTd).append(telTd).append(deptNameTd).append(groupNameId).append(
    ...
    function validate_add_form() {
        ...
        if (!regName.test(empName)) {
            ...
            show_validate_msg("#empName_add_input", "success", "名字可用");
    ...
    // 跳转至硬盘管理界面
    $("#hard_disk_management_btn").click(function () {
        window.location.href = "${APP_PATH}/hardDisk/send/";
    });
</script>
</body>
</html>